...
namespace Silk.NET.OpenGL.Extensions.ImGui {
    ...
    public class ImGuiController : IDisposable {
        ...
        private void SetStyle() {
            var s = ImGuiNET.ImGui.GetStyle();
            s.Colors[(int)ImGuiCol.WindowBg] = new(0.07f, 0.07f, 0.09f, 1.00f);
            s.Colors[(int)ImGuiCol.MenuBarBg] = new(0.12f, 0.12f, 0.15f, 1.00f); // #131318

            s.Colors[(int)ImGuiCol.PopupBg] = new(0.18f, 0.18f, 0.22f, 1.00f);
        
	        // Borders
            s.Colors[(int)ImGuiCol.Border] = new(0.25f, 0.25f, 0.25f, 1.00f);
            s.Colors[(int)ImGuiCol.BorderShadow] = new(0.00f, 0.00f, 0.00f, 0.00f);
        
	        // Headers
	        s.Colors[(int)ImGuiCol.Header] = new(0.18f, 0.18f, 0.22f, 1.00f);
	        s.Colors[(int)ImGuiCol.HeaderHovered] = new(0.30f, 0.30f, 0.40f, 1.00f);
	        s.Colors[(int)ImGuiCol.HeaderActive] = new(0.25f, 0.25f, 0.35f, 1.00f);
        
	        // Buttons
	        s.Colors[(int)ImGuiCol.Button] = new(0.20f, 0.22f, 0.27f, 1.00f);
	        s.Colors[(int)ImGuiCol.ButtonHovered] = new(0.30f, 0.32f, 0.40f, 1.00f);
	        s.Colors[(int)ImGuiCol.ButtonActive] = new(0.35f, 0.38f, 0.50f, 1.00f);
        
	        // Frame BG
	        s.Colors[(int)ImGuiCol.FrameBg] = new(0.15f, 0.15f, 0.18f, 1.00f);
	        s.Colors[(int)ImGuiCol.FrameBgHovered] = new(0.22f, 0.22f, 0.27f, 1.00f);
	        s.Colors[(int)ImGuiCol.FrameBgActive] = new(0.25f, 0.25f, 0.30f, 1.00f);
        
	        // Tabs
	        s.Colors[(int)ImGuiCol.Tab] = new(0.18f, 0.18f, 0.22f, 1.00f);
            s.Colors[(int)ImGuiCol.TabSelected] = new(0.25f, 0.25f, 0.38f, 1.00f);
            s.Colors[(int)ImGuiCol.TabSelectedOverline] = new(0.70f, 0.90f, 1.00f, 1.00f);
            s.Colors[(int)ImGuiCol.TabDimmed] = new(0.18f, 0.18f, 0.22f, 1.00f);
            s.Colors[(int)ImGuiCol.TabDimmedSelected] = new(0.25f, 0.25f, 0.38f, 1.00f);
            s.Colors[(int)ImGuiCol.TabDimmedSelectedOverline] = new(0.00f, 0.00f, 0.00f, 0.00f);
            s.Colors[(int)ImGuiCol.TabHovered] = new(0.35f, 0.35f, 0.50f, 1.00f);
        
	        // Title
	        s.Colors[(int)ImGuiCol.TitleBg] = new(0.12f, 0.12f, 0.15f, 1.00f);
	        s.Colors[(int)ImGuiCol.TitleBgActive] = new(0.12f, 0.12f, 0.15f, 1.00f);
	        s.Colors[(int)ImGuiCol.TitleBgCollapsed] = new(0.12f, 0.12f, 0.15f, 1.00f);
	        // colors[ImGuiCol_TitleBgActive] = ImVec4(0.15f, 0.15f, 0.20f, 1.00f);
	        // colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.10f, 0.10f, 0.12f, 1.00f);
        
	        // Text
	        s.Colors[(int)ImGuiCol.Text] = new(0.90f, 0.90f, 0.95f, 1.00f);
	        s.Colors[(int)ImGuiCol.TextDisabled] = new(0.50f, 0.50f, 0.55f, 1.00f);
        
	        // Highlights
	        s.Colors[(int)ImGuiCol.CheckMark] = new(0.50f, 0.70f, 1.00f, 1.00f);
	        s.Colors[(int)ImGuiCol.SliderGrab] = new(0.50f, 0.70f, 1.00f, 1.00f);
	        s.Colors[(int)ImGuiCol.SliderGrabActive] = new(0.60f, 0.80f, 1.00f, 1.00f);
	        s.Colors[(int)ImGuiCol.ResizeGrip] = new(0.50f, 0.70f, 1.00f, 0.50f);
	        s.Colors[(int)ImGuiCol.ResizeGripHovered] = new(0.60f, 0.80f, 1.00f, 0.75f);
	        s.Colors[(int)ImGuiCol.ResizeGripActive] = new(0.70f, 0.90f, 1.00f, 1.00f);
	        s.Colors[(int)ImGuiCol.Separator] = new(0.50f, 0.70f, 1.00f, 0.50f);
	        s.Colors[(int)ImGuiCol.SeparatorHovered] = new(0.60f, 0.80f, 1.00f, 0.75f);
	        s.Colors[(int)ImGuiCol.SeparatorActive] = new(0.70f, 0.90f, 1.00f, 1.00f);
        
	        // Scrollbar
	        s.Colors[(int)ImGuiCol.ScrollbarBg] = new(0.10f, 0.10f, 0.12f, 1.00f);
